...
<head>
    ...
    <!-- Icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo $theme_directory_url ?>/icons/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo $theme_directory_url ?>/icons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo $theme_directory_url ?>/icons/favicon-16x16.png">
